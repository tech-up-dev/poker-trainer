  ...
  return (
    <>
      <ConfirmDialog
        ...
        message="This immediately removes the glossary entry from both staging and the live app. Lessons that reference this term will be updated automatically. This cannot be undone."
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            <GlossaryEditor onPublishedContextChange={setPublished} initialText={initialText} />
          </div>
          <div className="space-y-8">
            {published.contentId !== null && published.contentType !== null ? (
              ...
              <p className="text-sm text-ink-3">
                Validate a glossary entry to see its staging and production copies.
              </p>
            )}
          </div>
        </div>
